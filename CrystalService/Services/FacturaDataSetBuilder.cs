...
namespace CrystalService.Services
{
    public static class FacturaDataSetBuilder
    {
        ...
        public static DataSet FillFactura01DataSet(DataSet ds, FacturaRenderRequest req)
        {
            ...
            if (req.detalles != null)
            {
                ...
                foreach (var d in req.detalles)
                {
                    ...
                    var detallesAdicionales = (d.detallesAdicionales ?? new List<DetalleAdicional>())
                        .Where(x => x != null)
                        .Take(3)
                        .ToList();
                    ...
                    // Mantiene compatibilidad con reportes que aún lean la tabla hija,
                    // evitando duplicar la fila de detalle en N registros.
        ...
        private static void SetDetalleAdicionalColumnas(DataRow detalleRow, int indice, DetalleAdicional adicional)
        {
